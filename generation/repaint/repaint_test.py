...
def main(conf: conf_mgt.Default_Conf):
    ...
    def model_fn(x, t, y=None, gt=None, **kwargs):
        assert y is not None
        return model(x, t, y if conf.class_cond else None)
    ...
    for batch in iter(dl):
        ...
        gts = gts.cpu().numpy()
        lrs = lrs.cpu().numpy()
        gt_keep_masks = gt_keep_masks.cpu().numpy()
...
### cd /home/seungyup/Projects/embc_experiments
### python3 repaint/repaint_test.py  --conf_path repaint/conf_repaint.yml 