...
def get_T_joi_from_common_rig_hand(env):
    ...
    # Right hand
    p_rthumb_1 = env.get_p_body(body_name='rthumb_l2')
    p_rthumb_2 = env.get_p_body(body_name='rthumb_l3')
    p_rthumb_3 = env.get_p_body(body_name='rthumb_end')
        
    p_rindex_0 = env.get_p_body(body_name='rindex_l1')
    p_rindex_1 = env.get_p_body(body_name='rindex_l2')
    p_rindex_2 = env.get_p_body(body_name='rindex_l3')
    p_rindex_3 = env.get_p_body(body_name='rindex_end')
        
    p_rmiddle_0 = env.get_p_body(body_name='rmiddle_l1')
    p_rmiddle_1 = env.get_p_body(body_name='rmiddle_l2')
    p_rmiddle_2 = env.get_p_body(body_name='rmiddle_l3')
    p_rmiddle_3 = env.get_p_body(body_name='rmiddle_end')
        
    p_rring_0 = env.get_p_body(body_name='rring_l1')
    p_rring_1 = env.get_p_body(body_name='rring_l2')
    p_rring_2 = env.get_p_body(body_name='rring_l3')
    p_rring_3 = env.get_p_body(body_name='rring_end')
        
    p_rpinky_0 = env.get_p_body(body_name='rpinky_l1')
    p_rpinky_1 = env.get_p_body(body_name='rpinky_l2')
    p_rpinky_2 = env.get_p_body(body_name='rpinky_l3')
    p_rpinky_3 = env.get_p_body(body_name='rpinky_end')
    
    # Left hand
    p_lthumb_1 = env.get_p_body(body_name='lthumb_l2')
    p_lthumb_2 = env.get_p_body(body_name='lthumb_l3')
    p_lthumb_3 = env.get_p_body(body_name='lthumb_end')
        
    p_lindex_0 = env.get_p_body(body_name='lindex_l1')
    p_lindex_1 = env.get_p_body(body_name='lindex_l2')
    p_lindex_2 = env.get_p_body(body_name='lindex_l3')
    p_lindex_3 = env.get_p_body(body_name='lindex_end')
        
    p_lmiddle_0 = env.get_p_body(body_name='lmiddle_l1')
    p_lmiddle_1 = env.get_p_body(body_name='lmiddle_l2')
    p_lmiddle_2 = env.get_p_body(body_name='lmiddle_l3')
    p_lmiddle_3 = env.get_p_body(body_name='lmiddle_end')
        
    p_lring_0 = env.get_p_body(body_name='lring_l1')
    p_lring_1 = env.get_p_body(body_name='lring_l2')
    p_lring_2 = env.get_p_body(body_name='lring_l3')
    p_lring_3 = env.get_p_body(body_name='lring_end')
        
    p_lpinky_0 = env.get_p_body(body_name='lpinky_l1')
    p_lpinky_1 = env.get_p_body(body_name='lpinky_l2')
    p_lpinky_2 = env.get_p_body(body_name='lpinky_l3')
    p_lpinky_3 = env.get_p_body(body_name='lpinky_end')
